<template>
    <div class="divide-2 group flex divide-rhino-400 rounded-md bg-rhino-50 w-full">
        <input class="input w-full rounded-r-none" type="text" @focus="newAnswerFocused = true" @blur="newAnswerFocused = false" v-model="newAnswer" @keyup.enter="e=> e.target.blur()"  placeholder="Введите новый ответ" ref="newAnswer">
